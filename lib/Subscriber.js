...
module.exports = class Subscriber extends EventEmitter 
{
    ...
    allowEvents, params, extraHeaders }) 
  {
    ...
    // Set subscriber dialog parameters.
    ...
    // Create cseq if not defined custom cseq.
    ...
    let eventValue = parsed.event;
    const eventId = parsed.params && parsed.params.id;
    
    if (eventId)
    {
      eventValue += `;id=${this.eventId}`;
    }
  ...
  _send(body, headers) 
  {
    ...
    const requestSender = new RequestSender(this._ua, request, this);
