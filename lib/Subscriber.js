...
module.exports = class Subscriber extends EventEmitter 
{
  ...
  _sendInitialSubscribe(body)
  {
    ...
    this._request = new SIPMessage.OutgoingRequest(JsSIP_C.SUBSCRIBE, 
  ...
  _receiveSubscribeResponse(response) 
  {
    if (response.status_code >= 200 && response.status_code < 300) 
    {
      ...
      if (this._dialog === null) 
      {
        ...
        // After the event dialog created.
  ...
  _sendSubsequentSubscribe(body, headers)
  {
    ...
    this._dialog.sendRequest(JsSIP_C.SUBSCRIBE, { body, extraHeaders: headers });
  }
